    ...
    value: function renderSelectRowHeader() {
      if (this.props.rowSelectType == _Const2['default'].ROW_SELECT_SINGLE) {
        ...
        return _react2['default'].createElement(
          ...
          null,
          _react2['default'].createElement('input', { type: 'checkbox', onChange: this.props.onSelectAllRow, checked: this.props.isSelectAll })
        );
      } else {
        return null;
      }
...
TableHeader.propTypes = {
  ...
  isSelectAll: _react2['default'].PropTypes.bool
};
